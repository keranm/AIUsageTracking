...
enum UsageState: Equatable {
    ...
    var menuBarLabel: String {
        switch self {
        case .idle:               return "—"
        case .healthy, .warning:  return ""  // caller appends percent
    ...
    var guidanceText: String {
        ...
        case .healthy:   return "Safe to start medium tasks"
        case .warning:   return "Large tasks may hit quota limit"
        case .critical:  return "Quota exhaustion likely soon"
        case .resetting: return "Window reset — good for another session"
        }
    }
}
